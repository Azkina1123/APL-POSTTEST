...
void duaAngka(char);                        // jika memilih 2 angka/parameter
void tigaAngka(char);                       // jika memilih 3 angka/parameter
...
void welcome(){
    ...
    cout << setw(40) << "=-=-=-=-=-=-=-=-=-=-=-=\n"
         << setw(40) << "= APLIKASI KALKULATOR =\n"
         << setw(40) << "=-=-=-=-=-=-=-=-=-=-=-=\n";

    cout << endl;

    cout << setw(32) << "WELCOME!" << endl;
    
    cout << endl;

    warnaText(6);
    cout << setw(39) << "Tekan ENTER untuk masuk" << endl;
    warnaText(7);
