...
Song *hapusLagu(Song arrayLagu[], int index) {
    for (int i=index; i<STORAGE; i++){
        ...
        if (arrayLagu[i].title != ""){                 
            arrayLagu[i].title = arrayLagu[i+1].title;
            arrayLagu[i].artist = arrayLagu[i+1].artist;
            arrayLagu[i].album = arrayLagu[i+1].album;
            arrayLagu[i].duration = arrayLagu[i+1].duration;
            arrayLagu[i].genre[0] = arrayLagu[i+1].genre[0];
            arrayLagu[i].genre[1] = arrayLagu[i+1].genre[1];
            arrayLagu[i].genre[2] = arrayLagu[i+1].genre[2];
            arrayLagu[i].year = arrayLagu[i+1].year;
        } 
    }
